...
class QR_BarCode{
    ...
    public function email($email = null, $subject = null, $message = null) {
        ...
        $this->codeData="mailto:$email?subject=$subject&body=$message";
    }
    ...
    public function sms($phone = null, $msg = null) {
        $this->codeData = "sms:$phone?body=$msg";
    }
     ...
     * @return bool
     */
    public function qrCode($size = 300, $filename = null) {
        $ch = curl_init();
        ...
        if($img) {
            if($filename) {
                ...
                exit(file_put_contents($filename, $img));
            } else {
